...
def init(
    ...
    core_only: bool = typer.Option(False, "--core-only", help="Cache only; skip extras even if installed."),
    no_banner: bool = typer.Option(False, "--no-banner"),
) -> None:
    """Resolve compatible tools, write the overlay, regenerate CREDITS.md."""
    _banner(no_banner)

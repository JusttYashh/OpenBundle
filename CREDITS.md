...
- [Semantic Router](https://github.com/aurelio-labs/semantic-router) — MIT
  Semantic Router (github.com/aurelio-labs/semantic-router, MIT)
...
- [OpenObserve](https://github.com/openobserve/openobserve) — Apache-2.0
  OpenObserve (github.com/openobserve/openobserve, Apache-2.0)

- [OpenMeter](https://github.com/openmeterio/openmeter) — Apache-2.0
  OpenMeter (github.com/openmeterio/openmeter, Apache-2.0)

- [AgentOps](https://github.com/AgentOps-AI/agentops) — MIT
  AgentOps (github.com/AgentOps-AI/agentops, MIT)

- [Agenta](https://github.com/Agenta-AI/agenta) — MIT
  Agenta (github.com/Agenta-AI/agenta, MIT)

- [LMCache](https://github.com/LMCache/LMCache) — Apache-2.0
  LMCache (github.com/LMCache/LMCache, Apache-2.0)

- [kvcached](https://github.com/ovg-project/kvcached) — Apache-2.0
  kvcached (github.com/ovg-project/kvcached, Apache-2.0)

- [KVzip](https://github.com/snu-mllab/KVzip) — MIT
  KVzip (github.com/snu-mllab/KVzip, MIT)

- [DeepSpec](https://github.com/deepseek-ai/DeepSpec) — MIT
  DeepSpec (github.com/deepseek-ai/DeepSpec, MIT)
...
- [Arize Phoenix](https://github.com/Arize-ai/phoenix) — Elastic-2.0
  Arize Phoenix (github.com/Arize-ai/phoenix, Elastic-2.0)
